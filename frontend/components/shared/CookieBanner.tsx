 ...
 * @sync-with /Users/fatbookpro/Desktop/housler_pervichka/frontend/src/components/CookieBanner.tsx
 *
 * This component should be kept in sync with agent.housler.ru CookieBanner.
        ...
        {!isExpanded ? (
          ...
          <div className="space-y-4">
            <div className="text-sm text-[var(--color-text)] space-y-3">
              <p>
                Нажимая «Принять все» вы даёте{' '}
                <Link
                  href={`${DOCS_BASE_URL}/doc/clients/soglasiya/cookie`}
                  target="_blank"
              ...
              <p>
                <strong>ООО «Сектор ИТ»</strong> обрабатывает cookie, в том числе через
              ...
              <p>
                Нажимая «Отклонить все» или продолжая использовать сайт,
